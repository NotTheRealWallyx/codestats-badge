...
describe('validateRequest', () => {
    ...
    it('returns valid for correct input', () => {
        expect(validateRequest({ username: 'foo', theme: 'dark' })).toEqual({ valid: true });
        expect(validateRequest({ username: 'foo', theme: 'light' })).toEqual({ valid: true });
        expect(validateRequest({ username: 'foo', theme: undefined })).toEqual({ valid: true });
    });
});
